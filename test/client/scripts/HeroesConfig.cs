...
namespace ConfigData {
  ...
  public static partial class HeroesConfigReflection {
    ...
    static HeroesConfigReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            "ChNIZXJvZXNfQ29uZmlnLnByb3RvEgpDb25maWdEYXRhIqQCChFBcHBlYXJh",
            ...
            "Z2Vfc291bmQYDCABKAkSFAoMZGVhdGhfZWZmZWN0GA0gASgJEhQKDG1vZGVs",
            "X2hlaWdodBgOIAEoAiLXBwoNSGVyb2VzX0NvbmZpZxIKCgJpZBgBIAEoDRIM",
            "CgRkZXNjGAIgASgJEhMKC2RlYnVnX2xldmVsGAMgASgNEhMKC2RlYnVnX2Zs",
            "b29yGAQgASgNEh4KFmRlYnVnX3Bhd25fY291bnRfbGV2ZWwYBSABKA0SEgoK",
            "ZGVidWdfcmFuaxgGIAEoDRIUCgxkZWJ1Z190YWxlbnQYByADKA0SGAoQaGVy",
            "b19uYW1lX2dsb2JhbBgIIAEoCRIWCg5pY29uX2Zvcm1hdGlvbhgJIAEoCRIR",
            "CglpY29uX2ZsYWcYCiABKAkSGgoSdGVhbV9iYW5uZXJfaGVpZ2h0GAsgASgF",
            "EhAKCGNsYXNzaWZ5GAwgASgNEhEKCWhlcm9fdHlwZRgNIAEoDRIPCgdxdWFs",
            "aXR5GA4gASgNEhUKDXByb2plY3RpbGVfaWQYDyABKA0SFQoNdGVhbWxvaWdp",
            "Y19pZBgQIAEoDRIOCgZza2lsbHMYESADKA0SDAoEbWFzcxgSIAEoAhIVCg1w",
            "aHlzaWNfcmFkaXVzGBMgAygCEg0KBXNjYWxlGBQgASgCEhQKDHNoYWRvd19z",
            "Y2FsZRgVIAMoAhITCgtjYW5fY2FwdHVyZRgWIAEoCBIYChBoZXJvX3NvdW5k",
            "X3Nob3J0GBcgASgJEhEKCW1lbGVlX2RwcxgYIAEoAhITCgttZWxlZV9zcGVl",
            "ZBgZIAEoAhIUCgxtZWxlZV9yYWRpdXMYGiABKAISGAoQbWVsZWVfaGl0X2Vm",
            "ZmVjdBgbIAMoCRIRCglyYW5nZV9kcHMYHCABKAISEwoLcmFuZ2Vfc3BlZWQY",
            "HSABKAISFAoMcmFuZ2VfcmFkaXVzGB4gASgCEhgKEHJhbmdlX2hpdF9lZmZl",
            "Y3QYHyADKAkSEgoKY2hhcmdlX2RtZxggIAEoAhIaChJjaGFyZ2VfYW5pbV9l",
            "ZmZlY3QYISABKAkSHgoWY2hhcmdlX2FuaW1fZWZmZWN0X2hpdBgiIAEoCRIW",
            "Cg5mb2N1c19hbHRpdHVkZRgjIAEoAhISCgpjcmlfZGFtYWdlGCQgASgCEhMK",
            "C2Z1bGxfdGFsZW50GCUgASgIEhQKDGNhdGNoX3Jld2FyZBgmIAEoDRIWCg5o",
            "ZXJvX2RldmlhdGlvbhgnIAEoCRIUCgxoZXJvX3Byb2ZpbGUYKCADKA0SGAoQ",
            "bWF4X2FjdGlvbl9wb2ludBgpIAEoDRIOCgZtb3JhbGUYKiABKA0SEgoKbW9y",
            "YWxlX2F0axgrIAEoDRISCgptb3JhbGVfZGVmGCwgASgNEhMKC2RlYWRfbW9y",
            "YWxlGC0gASgNIo0BChJIZXJvc19Xb3Jkc19Db25maWcSCgoCaWQYASABKA0S",
            "DRItCgV2YWx1ZRgCIAEoCzIeLkNvbmZpZ0RhdGEuSGVyb2VzX1JhbmtfQ29u",
            "ZmlnOgI4ARpYChhTb2xvSGVyb0NvbmZpZ0l0ZW1zRW50cnkSCwoDa2V5GAEg",
            "ASgNEisKBXZhbHVlGAIgASgLMhwuQ29uZmlnRGF0YS5Tb2xvX0hlcm9fQ29u",
            "ZmlnOgI4ARplCh5Tb2xvSGVyb2VzRGF0YUNvbmZpZ0l0ZW1zRW50cnkSCwoD",
            "a2V5GAEgASgNEjIKBXZhbHVlGAIgASgLMiMuQ29uZmlnRGF0YS5Tb2xvX0hl",
            "cm9lc19EYXRhX0NvbmZpZzoCOAEaWAoYVUlIZXJvZXNDb25maWdJdGVtc0Vu",
            "dHJ5EgsKA2tleRgBIAEoDRIrCgV2YWx1ZRgCIAEoCzIcLkNvbmZpZ0RhdGEu",
            "VUlfSGVyb2VzX0NvbmZpZzoCOAEaXAoaSGVyb2VzVHlwZUNvbmZpZ0l0ZW1z",
            "RW50cnkSCwoDa2V5GAEgASgNEi0KBXZhbHVlGAIgASgLMh4uQ29uZmlnRGF0",
            "YS5IZXJvZXNfVHlwZV9Db25maWc6AjgBQiMKIWNvbS50cmluaXRpZ2FtZXMu",
            "c2VydmVyLmNvbmYuYXV0b2IGcHJvdG8z"));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { },
          new pbr::GeneratedClrTypeInfo(null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::ConfigData.Appearance_Config), global::ConfigData.Appearance_Config.Parser, new[]{ "Id", "FolderName", "Mesh", "Texture", "AnimId", "BakeMesh", "ScaleMap", "ScaleLoading", "AtkSound", "RangeSound", "RangeHitSound", "ChargeSound", "DeathEffect", "ModelHeight" }, null, null, null),
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::ConfigData.Heros_Words_Config), global::ConfigData.Heros_Words_Config.Parser, new[]{ "Id", "BattleStartWords", "ChargeWords", "LastWords", "MapWords", "CityWords" }, null, null, null),
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::ConfigData.Heroes_Config_Data), global::ConfigData.Heroes_Config_Data.Parser, new[]{ "AppearanceConfigItems", "HeroesConfigItems", "HerosWordsConfigItems", "HeroesDataConfigItems", "HeroesSkillConfigItems", "HeroesRankConfigItems", "SoloHeroConfigItems", "SoloHeroesDataConfigItems", "UIHeroesConfigItems", "HeroesTypeConfigItems" }, null, null, new pbr::GeneratedClrTypeInfo[] { null, null, null, null, null, null, null, null, null, null, })
          }));
    }
    #endregion
  ...
  public sealed partial class Appearance_Config : pb::IMessage<Appearance_Config> {
    ...
    public const int ModelHeightFieldNumber = 14;
    ...
    public bool Equals(Appearance_Config other) {
      ...
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(ModelHeight, other.ModelHeight)) return false;
    ...
    public override int GetHashCode() {
      ...
      if (ModelHeight != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(ModelHeight);
  ...
  public sealed partial class Heroes_Config : pb::IMessage<Heroes_Config> {
    ...
    public Heroes_Config(Heroes_Config other) : this() {
      ...
      heroProfile_ = other.heroProfile_.Clone();
    ...
    private static readonly pb::FieldCodec<uint> _repeated_heroProfile_codec
        = pb::FieldCodec.ForUInt32(322);
    private readonly pbc::RepeatedField<uint> heroProfile_ = new pbc::RepeatedField<uint>();
    /// <summary>
    ///* 英雄列传 
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public pbc::RepeatedField<uint> HeroProfile {
    ...
    public bool Equals(Heroes_Config other) {
      ...
      if(!heroProfile_.Equals(other.heroProfile_)) return false;
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      heroProfile_.WriteTo(output, _repeated_heroProfile_codec);
      if (MaxActionPoint != 0) {
    ...
    public int CalculateSize() {
      ...
      size += heroProfile_.CalculateSize(_repeated_heroProfile_codec);
      if (MaxActionPoint != 0) {
    ...
    public void MergeFrom(Heroes_Config other) {
      ...
      heroProfile_.Add(other.heroProfile_);
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 322:
          case 320: {
            heroProfile_.AddEntriesFrom(input, _repeated_heroProfile_codec);
            break;
          }
          case 328: {
  ...
  public sealed partial class Heros_Words_Config : pb::IMessage<Heros_Words_Config> {
    ...
    public Heros_Words_Config(Heros_Words_Config other) : this() {
      ...
      mapWords_ = other.mapWords_.Clone();
      cityWords_ = other.cityWords_.Clone();
      _unknownFields = pb::UnknownFieldSet.Clone(other._unknownFields);
    }
    ...
    /// <summary>Field number for the "map_words" field.</summary>
    public const int MapWordsFieldNumber = 6;
    private static readonly pb::FieldCodec<string> _repeated_mapWords_codec
        = pb::FieldCodec.ForString(50);
    private readonly pbc::RepeatedField<string> mapWords_ = new pbc::RepeatedField<string>();
    /// <summary>
    ///* 世界地图说话 
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public pbc::RepeatedField<string> MapWords {
      get { return mapWords_; }
    }

    /// <summary>Field number for the "city_words" field.</summary>
    public const int CityWordsFieldNumber = 7;
    private static readonly pb::FieldCodec<string> _repeated_cityWords_codec
        = pb::FieldCodec.ForString(58);
    private readonly pbc::RepeatedField<string> cityWords_ = new pbc::RepeatedField<string>();
    /// <summary>
    ///* 城镇说话 
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public pbc::RepeatedField<string> CityWords {
      get { return cityWords_; }
    }
    ...
    public bool Equals(Heros_Words_Config other) {
      ...
      if(!mapWords_.Equals(other.mapWords_)) return false;
      if(!cityWords_.Equals(other.cityWords_)) return false;
      return Equals(_unknownFields, other._unknownFields);
    }
    ...
    public override int GetHashCode() {
      ...
      hash ^= mapWords_.GetHashCode();
      hash ^= cityWords_.GetHashCode();
      if (_unknownFields != null) {
        hash ^= _unknownFields.GetHashCode();
      }
      return hash;
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      mapWords_.WriteTo(output, _repeated_mapWords_codec);
      cityWords_.WriteTo(output, _repeated_cityWords_codec);
      if (_unknownFields != null) {
        _unknownFields.WriteTo(output);
      }
    }
    ...
    public int CalculateSize() {
      ...
      size += mapWords_.CalculateSize(_repeated_mapWords_codec);
      size += cityWords_.CalculateSize(_repeated_cityWords_codec);
      if (_unknownFields != null) {
        size += _unknownFields.CalculateSize();
      }
      return size;
    ...
    public void MergeFrom(Heros_Words_Config other) {
      ...
      mapWords_.Add(other.mapWords_);
      cityWords_.Add(other.cityWords_);
      _unknownFields = pb::UnknownFieldSet.MergeFrom(_unknownFields, other._unknownFields);
    }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 50: {
            mapWords_.AddEntriesFrom(input, _repeated_mapWords_codec);
            break;
          }
          case 58: {
            cityWords_.AddEntriesFrom(input, _repeated_cityWords_codec);
            break;
          }
        }
      }
  ...
  public sealed partial class Heroes_Config_Data : pb::IMessage<Heroes_Config_Data> {
    ...
    public Heroes_Config_Data(Heroes_Config_Data other) : this() {
      appearanceConfigItems_ = other.appearanceConfigItems_.Clone();
      heroesConfigItems_ = other.heroesConfigItems_.Clone();
      herosWordsConfigItems_ = other.herosWordsConfigItems_.Clone();
      heroesDataConfigItems_ = other.heroesDataConfigItems_.Clone();
      heroesSkillConfigItems_ = other.heroesSkillConfigItems_.Clone();
      heroesRankConfigItems_ = other.heroesRankConfigItems_.Clone();
      soloHeroConfigItems_ = other.soloHeroConfigItems_.Clone();
      soloHeroesDataConfigItems_ = other.soloHeroesDataConfigItems_.Clone();
      uIHeroesConfigItems_ = other.uIHeroesConfigItems_.Clone();
      heroesTypeConfigItems_ = other.heroesTypeConfigItems_.Clone();
      _unknownFields = pb::UnknownFieldSet.Clone(other._unknownFields);
    }
    ...
    /// <summary>Field number for the "Appearance_Config_items" field.</summary>
    public const int AppearanceConfigItemsFieldNumber = 1;
    private static readonly pbc::MapField<uint, global::ConfigData.Appearance_Config>.Codec _map_appearanceConfigItems_codec
        = new pbc::MapField<uint, global::ConfigData.Appearance_Config>.Codec(pb::FieldCodec.ForUInt32(8), pb::FieldCodec.ForMessage(18, global::ConfigData.Appearance_Config.Parser), 10);
    private readonly pbc::MapField<uint, global::ConfigData.Appearance_Config> appearanceConfigItems_ = new pbc::MapField<uint, global::ConfigData.Appearance_Config>();
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public pbc::MapField<uint, global::ConfigData.Appearance_Config> AppearanceConfigItems {
      get { return appearanceConfigItems_; }
    }

    /// <summary>Field number for the "Heroes_Config_items" field.</summary>
    public const int HeroesConfigItemsFieldNumber = 2;
    private static readonly pbc::MapField<uint, global::ConfigData.Heroes_Config>.Codec _map_heroesConfigItems_codec
        = new pbc::MapField<uint, global::ConfigData.Heroes_Config>.Codec(pb::FieldCodec.ForUInt32(8), pb::FieldCodec.ForMessage(18, global::ConfigData.Heroes_Config.Parser), 18);
    private readonly pbc::MapField<uint, global::ConfigData.Heroes_Config> heroesConfigItems_ = new pbc::MapField<uint, global::ConfigData.Heroes_Config>();
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public pbc::MapField<uint, global::ConfigData.Heroes_Config> HeroesConfigItems {
      get { return heroesConfigItems_; }
    }

    /// <summary>Field number for the "Heros_Words_Config_items" field.</summary>
    public const int HerosWordsConfigItemsFieldNumber = 3;
    private static readonly pbc::MapField<uint, global::ConfigData.Heros_Words_Config>.Codec _map_herosWordsConfigItems_codec
        = new pbc::MapField<uint, global::ConfigData.Heros_Words_Config>.Codec(pb::FieldCodec.ForUInt32(8), pb::FieldCodec.ForMessage(18, global::ConfigData.Heros_Words_Config.Parser), 26);
    private readonly pbc::MapField<uint, global::ConfigData.Heros_Words_Config> herosWordsConfigItems_ = new pbc::MapField<uint, global::ConfigData.Heros_Words_Config>();
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public pbc::MapField<uint, global::ConfigData.Heros_Words_Config> HerosWordsConfigItems {
      get { return herosWordsConfigItems_; }
    }

    /// <summary>Field number for the "Heroes_Data_Config_items" field.</summary>
    public const int HeroesDataConfigItemsFieldNumber = 4;
    private static readonly pbc::MapField<uint, global::ConfigData.Heroes_Data_Config>.Codec _map_heroesDataConfigItems_codec
        = new pbc::MapField<uint, global::ConfigData.Heroes_Data_Config>.Codec(pb::FieldCodec.ForUInt32(8), pb::FieldCodec.ForMessage(18, global::ConfigData.Heroes_Data_Config.Parser), 34);
    private readonly pbc::MapField<uint, global::ConfigData.Heroes_Data_Config> heroesDataConfigItems_ = new pbc::MapField<uint, global::ConfigData.Heroes_Data_Config>();
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public pbc::MapField<uint, global::ConfigData.Heroes_Data_Config> HeroesDataConfigItems {
      get { return heroesDataConfigItems_; }
    }

    /// <summary>Field number for the "Heroes_Skill_Config_items" field.</summary>
    public const int HeroesSkillConfigItemsFieldNumber = 5;
    private static readonly pbc::MapField<uint, global::ConfigData.Heroes_Skill_Config>.Codec _map_heroesSkillConfigItems_codec
        = new pbc::MapField<uint, global::ConfigData.Heroes_Skill_Config>.Codec(pb::FieldCodec.ForUInt32(8), pb::FieldCodec.ForMessage(18, global::ConfigData.Heroes_Skill_Config.Parser), 42);
    private readonly pbc::MapField<uint, global::ConfigData.Heroes_Skill_Config> heroesSkillConfigItems_ = new pbc::MapField<uint, global::ConfigData.Heroes_Skill_Config>();
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public pbc::MapField<uint, global::ConfigData.Heroes_Skill_Config> HeroesSkillConfigItems {
      get { return heroesSkillConfigItems_; }
    }

    /// <summary>Field number for the "Heroes_Rank_Config_items" field.</summary>
    public const int HeroesRankConfigItemsFieldNumber = 6;
    private static readonly pbc::MapField<uint, global::ConfigData.Heroes_Rank_Config>.Codec _map_heroesRankConfigItems_codec
        = new pbc::MapField<uint, global::ConfigData.Heroes_Rank_Config>.Codec(pb::FieldCodec.ForUInt32(8), pb::FieldCodec.ForMessage(18, global::ConfigData.Heroes_Rank_Config.Parser), 50);
    private readonly pbc::MapField<uint, global::ConfigData.Heroes_Rank_Config> heroesRankConfigItems_ = new pbc::MapField<uint, global::ConfigData.Heroes_Rank_Config>();
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public pbc::MapField<uint, global::ConfigData.Heroes_Rank_Config> HeroesRankConfigItems {
      get { return heroesRankConfigItems_; }
    }

    /// <summary>Field number for the "Solo_Hero_Config_items" field.</summary>
    public const int SoloHeroConfigItemsFieldNumber = 7;
    private static readonly pbc::MapField<uint, global::ConfigData.Solo_Hero_Config>.Codec _map_soloHeroConfigItems_codec
        = new pbc::MapField<uint, global::ConfigData.Solo_Hero_Config>.Codec(pb::FieldCodec.ForUInt32(8), pb::FieldCodec.ForMessage(18, global::ConfigData.Solo_Hero_Config.Parser), 58);
    private readonly pbc::MapField<uint, global::ConfigData.Solo_Hero_Config> soloHeroConfigItems_ = new pbc::MapField<uint, global::ConfigData.Solo_Hero_Config>();
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public pbc::MapField<uint, global::ConfigData.Solo_Hero_Config> SoloHeroConfigItems {
      get { return soloHeroConfigItems_; }
    }

    /// <summary>Field number for the "Solo_Heroes_Data_Config_items" field.</summary>
    public const int SoloHeroesDataConfigItemsFieldNumber = 8;
    private static readonly pbc::MapField<uint, global::ConfigData.Solo_Heroes_Data_Config>.Codec _map_soloHeroesDataConfigItems_codec
        = new pbc::MapField<uint, global::ConfigData.Solo_Heroes_Data_Config>.Codec(pb::FieldCodec.ForUInt32(8), pb::FieldCodec.ForMessage(18, global::ConfigData.Solo_Heroes_Data_Config.Parser), 66);
    private readonly pbc::MapField<uint, global::ConfigData.Solo_Heroes_Data_Config> soloHeroesDataConfigItems_ = new pbc::MapField<uint, global::ConfigData.Solo_Heroes_Data_Config>();
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public pbc::MapField<uint, global::ConfigData.Solo_Heroes_Data_Config> SoloHeroesDataConfigItems {
      get { return soloHeroesDataConfigItems_; }
    }

    /// <summary>Field number for the "UI_Heroes_Config_items" field.</summary>
    public const int UIHeroesConfigItemsFieldNumber = 9;
    private static readonly pbc::MapField<uint, global::ConfigData.UI_Heroes_Config>.Codec _map_uIHeroesConfigItems_codec
        = new pbc::MapField<uint, global::ConfigData.UI_Heroes_Config>.Codec(pb::FieldCodec.ForUInt32(8), pb::FieldCodec.ForMessage(18, global::ConfigData.UI_Heroes_Config.Parser), 74);
    private readonly pbc::MapField<uint, global::ConfigData.UI_Heroes_Config> uIHeroesConfigItems_ = new pbc::MapField<uint, global::ConfigData.UI_Heroes_Config>();
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public pbc::MapField<uint, global::ConfigData.UI_Heroes_Config> UIHeroesConfigItems {
      get { return uIHeroesConfigItems_; }
    }

    /// <summary>Field number for the "Heroes_Type_Config_items" field.</summary>
    public const int HeroesTypeConfigItemsFieldNumber = 10;
    private static readonly pbc::MapField<uint, global::ConfigData.Heroes_Type_Config>.Codec _map_heroesTypeConfigItems_codec
        = new pbc::MapField<uint, global::ConfigData.Heroes_Type_Config>.Codec(pb::FieldCodec.ForUInt32(8), pb::FieldCodec.ForMessage(18, global::ConfigData.Heroes_Type_Config.Parser), 82);
    private readonly pbc::MapField<uint, global::ConfigData.Heroes_Type_Config> heroesTypeConfigItems_ = new pbc::MapField<uint, global::ConfigData.Heroes_Type_Config>();
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public pbc::MapField<uint, global::ConfigData.Heroes_Type_Config> HeroesTypeConfigItems {
      get { return heroesTypeConfigItems_; }
    }
    ...
    public bool Equals(Heroes_Config_Data other) {
      ...
      if (!AppearanceConfigItems.Equals(other.AppearanceConfigItems)) return false;
      if (!HeroesConfigItems.Equals(other.HeroesConfigItems)) return false;
      if (!HerosWordsConfigItems.Equals(other.HerosWordsConfigItems)) return false;
      if (!HeroesDataConfigItems.Equals(other.HeroesDataConfigItems)) return false;
      if (!HeroesSkillConfigItems.Equals(other.HeroesSkillConfigItems)) return false;
      if (!HeroesRankConfigItems.Equals(other.HeroesRankConfigItems)) return false;
      if (!SoloHeroConfigItems.Equals(other.SoloHeroConfigItems)) return false;
      if (!SoloHeroesDataConfigItems.Equals(other.SoloHeroesDataConfigItems)) return false;
      if (!UIHeroesConfigItems.Equals(other.UIHeroesConfigItems)) return false;
      if (!HeroesTypeConfigItems.Equals(other.HeroesTypeConfigItems)) return false;
      return Equals(_unknownFields, other._unknownFields);
    }
    ...
    public override int GetHashCode() {
      int hash = 1;
      hash ^= AppearanceConfigItems.GetHashCode();
      hash ^= HeroesConfigItems.GetHashCode();
      hash ^= HerosWordsConfigItems.GetHashCode();
      hash ^= HeroesDataConfigItems.GetHashCode();
      hash ^= HeroesSkillConfigItems.GetHashCode();
      hash ^= HeroesRankConfigItems.GetHashCode();
      hash ^= SoloHeroConfigItems.GetHashCode();
      hash ^= SoloHeroesDataConfigItems.GetHashCode();
      hash ^= UIHeroesConfigItems.GetHashCode();
      hash ^= HeroesTypeConfigItems.GetHashCode();
      if (_unknownFields != null) {
        hash ^= _unknownFields.GetHashCode();
      }
      return hash;
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public void WriteTo(pb::CodedOutputStream output) {
      appearanceConfigItems_.WriteTo(output, _map_appearanceConfigItems_codec);
      heroesConfigItems_.WriteTo(output, _map_heroesConfigItems_codec);
      herosWordsConfigItems_.WriteTo(output, _map_herosWordsConfigItems_codec);
      heroesDataConfigItems_.WriteTo(output, _map_heroesDataConfigItems_codec);
      heroesSkillConfigItems_.WriteTo(output, _map_heroesSkillConfigItems_codec);
      heroesRankConfigItems_.WriteTo(output, _map_heroesRankConfigItems_codec);
      soloHeroConfigItems_.WriteTo(output, _map_soloHeroConfigItems_codec);
      soloHeroesDataConfigItems_.WriteTo(output, _map_soloHeroesDataConfigItems_codec);
      uIHeroesConfigItems_.WriteTo(output, _map_uIHeroesConfigItems_codec);
      heroesTypeConfigItems_.WriteTo(output, _map_heroesTypeConfigItems_codec);
      if (_unknownFields != null) {
        _unknownFields.WriteTo(output);
      }
    }
    ...
    public int CalculateSize() {
      int size = 0;
      size += appearanceConfigItems_.CalculateSize(_map_appearanceConfigItems_codec);
      size += heroesConfigItems_.CalculateSize(_map_heroesConfigItems_codec);
      size += herosWordsConfigItems_.CalculateSize(_map_herosWordsConfigItems_codec);
      size += heroesDataConfigItems_.CalculateSize(_map_heroesDataConfigItems_codec);
      size += heroesSkillConfigItems_.CalculateSize(_map_heroesSkillConfigItems_codec);
      size += heroesRankConfigItems_.CalculateSize(_map_heroesRankConfigItems_codec);
      size += soloHeroConfigItems_.CalculateSize(_map_soloHeroConfigItems_codec);
      size += soloHeroesDataConfigItems_.CalculateSize(_map_soloHeroesDataConfigItems_codec);
      size += uIHeroesConfigItems_.CalculateSize(_map_uIHeroesConfigItems_codec);
      size += heroesTypeConfigItems_.CalculateSize(_map_heroesTypeConfigItems_codec);
      if (_unknownFields != null) {
        size += _unknownFields.CalculateSize();
      }
      return size;
    ...
    public void MergeFrom(Heroes_Config_Data other) {
      ...
      appearanceConfigItems_.Add(other.appearanceConfigItems_);
      heroesConfigItems_.Add(other.heroesConfigItems_);
      herosWordsConfigItems_.Add(other.herosWordsConfigItems_);
      heroesDataConfigItems_.Add(other.heroesDataConfigItems_);
      heroesSkillConfigItems_.Add(other.heroesSkillConfigItems_);
      heroesRankConfigItems_.Add(other.heroesRankConfigItems_);
      soloHeroConfigItems_.Add(other.soloHeroConfigItems_);
      soloHeroesDataConfigItems_.Add(other.soloHeroesDataConfigItems_);
      uIHeroesConfigItems_.Add(other.uIHeroesConfigItems_);
      heroesTypeConfigItems_.Add(other.heroesTypeConfigItems_);
      _unknownFields = pb::UnknownFieldSet.MergeFrom(_unknownFields, other._unknownFields);
    }
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          default:
            ...
            break;
          case 10: {
            appearanceConfigItems_.AddEntriesFrom(input, _map_appearanceConfigItems_codec);
            break;
          }
          case 18: {
            heroesConfigItems_.AddEntriesFrom(input, _map_heroesConfigItems_codec);
            break;
          }
          case 26: {
            herosWordsConfigItems_.AddEntriesFrom(input, _map_herosWordsConfigItems_codec);
            break;
          }
          case 34: {
            heroesDataConfigItems_.AddEntriesFrom(input, _map_heroesDataConfigItems_codec);
            break;
          }
          case 42: {
            heroesSkillConfigItems_.AddEntriesFrom(input, _map_heroesSkillConfigItems_codec);
            break;
          }
          case 50: {
            heroesRankConfigItems_.AddEntriesFrom(input, _map_heroesRankConfigItems_codec);
            break;
          }
          case 58: {
            soloHeroConfigItems_.AddEntriesFrom(input, _map_soloHeroConfigItems_codec);
            break;
          }
          case 66: {
            soloHeroesDataConfigItems_.AddEntriesFrom(input, _map_soloHeroesDataConfigItems_codec);
            break;
          }
          case 74: {
            uIHeroesConfigItems_.AddEntriesFrom(input, _map_uIHeroesConfigItems_codec);
            break;
          }
          case 82: {
            heroesTypeConfigItems_.AddEntriesFrom(input, _map_heroesTypeConfigItems_codec);
            break;
          }
        }
      }
